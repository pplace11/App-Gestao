...
<head>
    ...
    <style>
        * {
        ...
        .auth-shell.exit {
            animation: slideOutLeft .45s ease forwards;
            pointer-events: none;
        }
        ...
        .brand-panel {
            padding: 52px 44px;
            background:
                radial-gradient(760px 360px at 0% 0%, rgba(84, 140, 255, 0.34), transparent 60%),
        ...
        html.light-theme .brand-panel {
            background:
                radial-gradient(760px 360px at 0% 0%, rgba(84, 140, 255, 0.22), transparent 60%),
        ...
        html.light-theme .login-panel {
            background: rgba(255, 255, 255, 0.82);
        }

        html.light-theme .login-panel h2 {
            color: #1b3363;
        }

        html.light-theme .subtitle,
        html.light-theme .remember label,
...
<div class="auth-shell" id="authShell">
    ...
    <aside class="brand-panel">
        ...
        <p>
            ...
            financeiro e operacoes diarias com seguranca.
        </p>
        <div class="brand-list">
            <span>• Fluxos de trabalho centralizados</span>
            <span>• Controlo de acessos e historico de atividade</span>
            <span>• Dados empresariais com alta confiabilidade</span>
        </div>
    </aside>

    <section class="login-panel">
        <h2>Entrar</h2>
        <p class="subtitle">Use as suas credenciais para continuar.</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="input-box">
                <label>Email</label>
                <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="email@email.com">
            </div>
            ...
            <div class="remember">
                ...
                <label for="remember">Manter sessao iniciada</label>
            </div>
        ...
        <div class="regi-link">
            Nao tem conta? <a id="goRegister" href="{{ route('register') }}">Criar conta</a>
        </div>
    </section>
</div>
